 ...
 * @author ARIF
 */
public class Kalkulator_D0221079 extends javax.swing.JFrame {
    String angka;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kalkulator_D0221079.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kalkulator_D0221079().setVisible(true);
            }
        });
    }
